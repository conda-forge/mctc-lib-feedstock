...
pixi add mctc-lib mctc-lib-devel
# for installing globally
pixi global install mctc-lib mctc-lib-devel
```
...
It is possible to list all of the versions of `mctc-lib` available on your platform:
...
```
pixi search mctc-lib --channel conda-forge
```
